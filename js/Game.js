class Game {
  constructor() {
    ...
    //Declarar una bandera para activar gasto de combustible
  ...
  //-----Diseño barra de Vida del jugador----
  /*showLife() {
    push();
  ...
  //----Diseño de la barra de combustible----
  /*showFuelBar() {
    push();
  ...
  handlePlayerControls() {
    if (keyIsDown(UP_ARROW)) {
      //Se activa de bandera para gastar combustible
  ...
  handleFuel(index) {
    ...
    //Se activa el gasto de combustible cuando avanzamos
    /*if(player.fuel > 0 && this.playerMoving){
      player.fuel -=0.3;
    }*/


    //Cuando se termina el combstible se termina el juego
    /*if(player.fuel <= 0){
      gameState = 2;
      this.gameOver();
    }*/
  ...
  // Construir Mensaje par el Jugador Ganador
  /*showRank() {
    swal({
      title: `Impresionante!${"\n"}Posición${"\n"}${player.rank}`,
  ...
  //Construir Mensaje Para el jugador que Pierda
  /*gameOver() {
    swal({
      title: `Fin del juego`,
